...
CREATE view [dbo].[FASTracker_EOM_PwC] as 
SELECT 
...
case when [dbo].[map_SBM].[UnrealizedEarnings] = '' then 'Not Posted' else left([dbo].[map_SBM].[UnrealizedEarnings],8) end as UnrealizedEarnings,
