...
CREATE view [dbo].[FASTracker_EOY_PrevEOM] as 
SELECT 
o.Desk,
o.Subdesk,
o.SubDeskCCY,
...
FROM ((([dbo].[FASTracker_Archive] 
		...
		Inner Join dbo.[AsOfDate] ON 
			[dbo].[FASTracker_Archive].AsOfDate = dbo.[AsOfDate].[AsOfDate_prevEOM]) 
		left join dbo.map_order o on 
			dbo.FASTracker_Archive.internalportfolio = o.portfolio)
		left join dbo.FXRate fx on		
			[dbo].[FASTracker_Archive].[AsofDate] = fx.AsOfDate AND
