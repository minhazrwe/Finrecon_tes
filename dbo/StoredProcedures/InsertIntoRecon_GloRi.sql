	...
	CREATE PROCEDURE [dbo].[InsertIntoRecon_GloRi] 
	AS
	BEGIN TRY
	...
	if @LogInfo >= 1  BEGIN insert into [dbo].[Logfile] select 'RealisedRecon - InsertIntoRecon - fill Recon', GETDATE () END

INSERT INTO Recon ( Identifier, InternalLegalEntity, ReconGroup, Desk, SubDesk, OrderNo, 
...
END TRY
	...
	BEGIN CATCH
		...
		EXEC [dbo].[usp_GetErrorInfo] '[dbo].[InsertIntoRecon]', 1
	END CATCH
