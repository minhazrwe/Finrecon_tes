CREATE TABLE [dbo].[SAP_Current_Month] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_SAP_Current_Month_2023_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_SAP_Current_Month_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
