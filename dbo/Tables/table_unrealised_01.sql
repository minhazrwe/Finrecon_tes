CREATE TABLE [dbo].[table_unrealised_01] (
    ...
    [Leg_Start_Date]                     DATE           NULL,
    [Leg_End_Date]                       DATE           NULL,
    ...
    [Unit_Of_Account]                    VARCHAR (3)    NULL,
    ...
    [Unrealised_Discounted_Cashflow_CCY] FLOAT (53)     NULL,
    [Realised_Discounted_Cashflow_CCY]   FLOAT (53)     NULL,
    [ToBeDeleted]                        INT            CONSTRAINT [DF_Table_Unrealised_01_ToBeDeleted] DEFAULT ((0)) NULL,
    [DataSource]                         VARCHAR (30)   NULL,
    [FileID]                             INT            NULL,
    [UserName]                           VARCHAR (30)   CONSTRAINT [DF_Table_Unrealised_01_UserName] DEFAULT (user_name()) NULL,
    [Last_Update]                        DATETIME       CONSTRAINT [DF_Table_Unrealised_01_Last_Update] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_unrealised_01] PRIMARY KEY CLUSTERED ([ID] ASC)
);
