CREATE TABLE [dbo].[SAP_2019] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_SAP_neu_mit_entry_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_SAP_neu_mit_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
