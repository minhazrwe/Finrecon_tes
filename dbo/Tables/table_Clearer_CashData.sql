CREATE TABLE [dbo].[table_Clearer_CashData] (
    ...
    [LastImport]              DATETIME      CONSTRAINT [DF_table_Clearer_CashData_LastImport] DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [PK_table_Clearer_CashData] PRIMARY KEY CLUSTERED ([ID] ASC)
);
