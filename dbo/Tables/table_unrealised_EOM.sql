CREATE TABLE [dbo].[table_unrealised_EOM] (
    ...
    [Last_Update]                                DATE          CONSTRAINT [DF_table_unrealised_EOM_Last_Update] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_table_unrealised_EOM ] PRIMARY KEY CLUSTERED ([ID] ASC)
);
