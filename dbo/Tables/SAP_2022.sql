CREATE TABLE [dbo].[SAP_2022] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_SAP_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_SAP_mit_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
