CREATE TABLE [dbo].[table_FxHedgeDelivery_SAP_Cash] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_table_FxHedgeDelivery_SAP_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_table_FxHedgeDelivery_SAP_mit_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
