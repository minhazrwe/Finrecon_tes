CREATE TABLE [dbo].[SAP_2018] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_SAP_2018_mit_entry_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_SAP_2018_mit_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
