CREATE TABLE [dbo].[map_SBM_Archive] (
    ...
    [TimeStamp]            DATETIME      CONSTRAINT [DF_map_SBM_Archive_TimeStamp] DEFAULT (getdate()) NULL,
    [User]                 VARCHAR (50)  CONSTRAINT [DF_map_SBM_Archive_User] DEFAULT (user_name()) NULL,
    CONSTRAINT [pk_map_SBM_Archive] PRIMARY KEY CLUSTERED ([ID] ASC)
);
