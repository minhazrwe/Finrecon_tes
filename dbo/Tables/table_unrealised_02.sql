CREATE TABLE [dbo].[table_unrealised_02] (
    ...
    [UserName]                                   VARCHAR (30)   CONSTRAINT [DF_Table_Unrealised_02_UserName] DEFAULT (user_name()) NULL,
    [Last_Update]                                DATETIME       CONSTRAINT [DF_Table_Unrealised_02_Last_Update] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_unrealised_02] PRIMARY KEY CLUSTERED ([ID] ASC)
);
