CREATE TABLE [dbo].[table_Clearer_DealData] (
    ...
    [LastImport]           DATETIME       CONSTRAINT [DF_table_Clearer_DealData_LastImport] DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [PK_table_Clearer_DealData] PRIMARY KEY CLUSTERED ([ID] ASC)
);
