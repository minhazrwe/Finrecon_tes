CREATE TABLE [dbo].[table_VM_NETTING_1a_DeferralInput] (
    ...
    [LastUpdate]       DATETIME       CONSTRAINT [DF_table_VM_NETTING_1a_DeferralInput_LastUpdate] DEFAULT (getdate()) NULL,
    [Desk]             VARCHAR (100)  NULL,
    CONSTRAINT [PK_table_VM_NETTING_DeferralInputneu] PRIMARY KEY CLUSTERED ([ID] ASC)
);
