CREATE TABLE [dbo].[table_FxHedgeDelivery_SAP_Debitor] (
    ...
    [TimeStamp]             DATETIME      CONSTRAINT [DF_table_FxHedgeDelivery_SAP_Debitor_timeTimeStamp] DEFAULT (getdate()) NULL,
    CONSTRAINT [pk_table_FxHedgeDelivery_SAP_Debitor_mit_entry_time] PRIMARY KEY CLUSTERED ([ID] ASC)
);
